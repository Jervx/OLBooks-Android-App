...
//        dbhelper.dropDbs(dbhelper.getWritableDatabase(), new String [] {"user"});
        ...
        try {
            ...
            dbhelper.insertBook("photonameonly", "ibn10here", "isbn13here", "titlehere", "authorname here", "category separated by <~> example : Coding<~>Nature<~>AI<~>Artificial", "Description here, dapat separated yung mga paragraph ng <~> example : Paragraph1 is this.... <~> Paragraph2 is this ", OlbookUtils.toISODateString(format.parse("31/04/2018")), OlbookUtils.toISODateString(new Date()), "pdffilename.pdf", 61400, 7234);
        } catch (Exception e) {
